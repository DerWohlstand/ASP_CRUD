...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="ASPProject.index" %>
...
<header class="header">
   ...
   <div  class="login-form" style="display:none">
      ...
      <input type="password" name="pwd" id="pwd" placeholder="enter your password" class="box"/>
      <div class="flex">
         <input type="checkbox" name="" id="remember-me" onclick="show()" ondblclick="unshow()">
         <label for="remember-me">show password</label>
         <a href="#">forgot password?</a>
      </div>
             <asp:Button ID="Button1" cssClass="btn" runat="server" Text="Submit"  BackColor="#111" ForeColor="White" Width="100%" OnClick="Button1_Click" />
...
<div class="contact-info">
   ...
   <div class="info">
      ...
      <h3>email address</h3>
      <p>aishwarya@gmail.com</p>
      <p>jawalekar@gmail.com</p>
   </div>
...
<section class="home" id="home">
   ...
   <div class="swiper home-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <section class="swiper-slide slide" style="background: url(imgupload/<%#Eval("img")%>) no-repeat;">
            <div class="content">
               <h3><%#Eval("heading") %></h3>
               <p><%#Eval("descp") %></p>
...
<section class="services" id="services">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <img src="imgupload/<%#Eval("img") %>" alt="">
         <h3><%#Eval("head") %></h3>
         <p><%#Eval("descp") %></p>
      </div>
                     </ItemTemplate>
...
<section class="projects" id="projects">
   ...
   <div class="box-container">
      ...
      <a href="imgupload/<%#Eval("img") %>" class="box">
         <div class="image">
            <img src="imgupload/<%#Eval("img") %>" alt="">
         </div>
         <div class="content">
...
<section class="reviews">
   ...
   <h1 class="heading"> clients reviews 
           <span> <a href="review.aspx"><i class="fas fa-plus"></i></a></span></h1>
...
<section class="contact" id="contact">
   ...
   <div class="row">
      ...
      <div class="form">
         <h3>get in touch</h3>
         <input type="text" placeholder="name" class="box" id="uname" name="uname"/>
         <input type="email" placeholder="email" class="box" name="emaill" id="emaill">
         <input type="number" placeholder="phone" class="box" name="phone" id="phone">
         <textarea name="" placeholder="message" class="box" id="" cols="30" rows="10" name="msg" id="msg" ></textarea>
   <asp:Button ID="submit" runat="server" Text="Submit" CssClass="btn" BorderStyle="None" BackColor=" #FFCA03" ForeColor="White"  BorderColor="White"  OnClick="submit_Click"/>
  </div>
...
<section class="footer">
   ...
   <div class="credit"> created by <span>Aishwarya</span> | all rights reserved! </div>
