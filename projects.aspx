<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="projects.aspx.cs" Inherits="ASPProject.projects" %>
...
<body>
    ...
    <div class=" file">
        <h2 class="text-left">Add Projects</h2>
        <hr>
         <div class="row file">
            <div class="col-4 ucol">
                <asp:FileUpload ID="FileUpload1" runat="server" />
             <p><b> image showuld be of 510 x 632px</b><br/>Maximum Image size should be(100KB) </p>
                                </div>
             <div class="col-4 ucol">
                 <h3>Heading</h3>
             ...
             <div class="col-4 ucol">
                 <h3>Description</h3>
                 <textarea class="text input" id="desc" name="desc" rows="3" cols="40"></textarea>
             </div>
             </div>
                     ...
                     <ItemTemplate>
                            <div class="row" style="padding-block:1rem">
                                <div class="col-1"><p><%#Eval("id") %></p></div>
                                 ...
                                 <div class="col-1"><a href="update3.aspx?id=<%#Eval("id") %>">Update</a></div>
