<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="update2.aspx.cs" Inherits="ASPProject.update2" %>
...
<body>
    ...
    <div class=" file">
        <h2 class="text-left">UPdate Services</h2>
        <hr>
         <div class="row file">
            <div class="col-4 ucol">
             ...
             <div class="col-4 ucol">
                 <h3>Heading</h3>
                <asp:TextBox ID="head" CssClass="text" runat="server"></asp:TextBox>             </div>
             <div class="col-4 ucol">
                 <h3>Description</h3>
