<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Services.aspx.cs" Inherits="ASPProject.Services" %>
...
<body>
    ...
    <div class=" file">
        <h2 class="text-left">Add Services</h2>
        <hr>
         <div class="row file">
                     ...
                     <ItemTemplate>
                            <div class="row" style="padding-block:1rem">
                                <div class="col-1"><p><%#Eval("id") %></p></div>
                                 ...
                                 <div class="col-1"><a href="update2.aspx?id=<%#Eval("id") %>" >Update</a></div>
